    ...
    <div class="card">
        ...
        <div class="row hostel-students">
            ...
            @foreach ($teachers as $teacher)
                <a href="{{route('admin.student.show', $teacher)}}">
                    <div class="col s4 m3 l3 center-align">
                        <div class="card hostel-student">
                            <img src="{{asset('image/teacher/'.$teacher->image)}}" alt="">
                            <p class="name">{{$teacher->user->name}}</p>
                            <p class="room">Dept. : {{$teacher->department->short_form}}</p>                        
                        </div>
                    </div>
                </a>
            @endforeach
...
<div class="col m3">
    <a href="{{route('admin.teacher.create')}}" class="btn red lighten-3">Add New Teacher</a>
</div>
